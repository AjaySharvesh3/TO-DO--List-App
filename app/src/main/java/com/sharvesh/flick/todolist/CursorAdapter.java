...
public class CursorAdapter extends RecyclerView.Adapter<CursorAdapter.TaskViewHolder> {
    ...
    public void onBindViewHolder(TaskViewHolder holder, int position) {
        ...
        int idIndex = mCursor.getColumnIndex(TaskContract.TaskEntryData._ID);
        int descriptionIndex = mCursor.getColumnIndex(TaskContract.TaskEntryData.DESCRIPTION);
        int priorityIndex = mCursor.getColumnIndex(TaskContract.TaskEntryData.PRIORITY);
